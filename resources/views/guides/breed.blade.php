...
@section('title', "Caractère de l'Abyssin - Guide race et foyer idéal")
@section('meta_description', "Découvrez le caractère du chat Abyssin, son niveau d'énergie, sa relation à l'humain et le type de foyer qui lui convient le mieux.")
...
@section('content')
    @php
        ...
        $articleSchema = [
            '@context' => 'https://schema.org',
            '@type' => 'Article',
            'headline' => "Le caractère du chat Abyssin",
            'description' => "Guide sur le tempérament de l'Abyssin et le type de foyer qui lui convient.",
    ...
    <section class="hero-glow glass-panel overflow-hidden px-6 py-10 sm:px-8 lg:px-12">
        <div class="max-w-4xl">
            ...
            <h1 class="page-title mt-4">Quel est vraiment le caractère du chat Abyssin ?</h1>
            <p class="body-copy mt-6 max-w-3xl">
                L'Abyssin est souvent recherché pour son élégance et sa présence, mais ce qui marque surtout
                au quotidien, c'est son intelligence, son mouvement et son besoin d'interaction. Cette page
                vous aide à savoir si ce tempérament correspond bien à votre foyer.
            </p>
        </div>
    </section>
    ...
    <section class="mt-12 grid gap-6 md:grid-cols-3">
        <article class="section-card p-6">
            ...
            <p class="subtle-text mt-4">
                L'Abyssin aime grimper, observer, jouer et participer à ce qui se passe autour de lui.
            </p>
        </article>
        <article class="section-card p-6">
            ...
            <p class="subtle-text mt-4">
                Il cherche souvent la présence du foyer et supporte mieux les environnements attentifs et vivants.
            </p>
        </article>
        <article class="section-card p-6">
            <p class="eyebrow">Rythme idéal</p>
            <h2 class="mt-3 text-4xl font-semibold text-amber-950">Stimule</h2>
            <p class="subtle-text mt-4">
                Jeux, hauteur, interactions et routine rassurante l'aident à s'épanouir durablement.
            </p>
        </article>
    </section>
    ...
    <section class="mt-12 grid gap-6 lg:grid-cols-[1fr_1fr]">
        <article class="section-card p-8">
            ...
            <h2 class="section-title mt-4">Les familles qui apprécient vraiment l'Abyssin</h2>
            <p class="body-copy mt-5">
                Cette race convient souvent aux personnes qui veulent un chat présent, vif et engagé dans la
                vie du foyer. Elle correspond bien à ceux qui aiment observer, jouer, échanger et aménager
                un cadre un peu plus riche qu'un simple espace de repos.
            </p>
            <p class="subtle-text mt-5">
                En revanche, si vous cherchez un chat très indépendant ou peu démonstratif, l'Abyssin peut
                ne pas être le profil le plus simple à long terme.
            </p>
        </article>
        ...
        <article class="luminous-panel p-8">
            ...
            <p class="mt-5 text-sm leading-7 text-white/85">
                ...
                et une vraie cohérence entre les besoins du chat et votre quotidien.
            </p>
