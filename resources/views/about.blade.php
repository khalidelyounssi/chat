...
@section('title', 'À propos de la chatterie d\'Abyssins - Chatterie des Soleils d\'Orient')
@section('meta_description', 'Présentation de la chatterie, de son approche familiale, de la socialisation des Abyssins et de l\'accompagnement à l\'adoption.')
...
@section('content')
    ...
    <section class="hero-glow glass-panel overflow-hidden px-6 py-10 sm:px-8 lg:px-12">
        <div class="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div class="mx-auto w-full max-w-md">
                <img src="{{ $logoAsset }}" alt="Identité visuelle de la chatterie" class="w-full">
            </div>
            <div>
                <p class="eyebrow">À propos</p>
                <h1 class="page-title mt-4">Une chatterie familiale pensée pour durer</h1>
                <p class="body-copy mt-6 max-w-2xl">
                    Nous élevons des Abyssins dans une logique de qualité, de confiance et de dialogue.
                    Le site a pour rôle de présenter l'essentiel sans surpromesse : tempérament, disponibilités,
                    modalités de contact et niveau d'accompagnement.
                </p>
    ...
    <section class="mt-12 grid gap-6 md:grid-cols-3">
        ...
        <article class="section-card p-6">
            ...
            <p class="subtle-text mt-4">
                Nous privilégions la prévention, le suivi et une communication simple autour de chaque profil.
            </p>
        </article>
        <article class="section-card p-6">
            ...
            <p class="subtle-text mt-4">
                Les chatons grandissent dans un environnement humain, doux et rassurant, avec des repères stables.
            </p>
        </article>
    </section>
    ...
    <section class="mt-12 grid gap-6 lg:grid-cols-[1fr_1fr]">
        <article class="section-card p-8">
            ...
            <h2 class="section-title mt-4">Une présentation honnête et un contact accessible</h2>
        ...
        <article class="luminous-panel p-8">
            ...
            <h2 class="mt-4 font-display text-5xl leading-tight text-white">Comment se passe l'échange ?</h2>
            <div class="mt-6 grid gap-4">
                @foreach ($adoptionSteps as $index => $step)
                    <div class="rounded-[1.5rem] bg-white/10 px-5 py-4 backdrop-blur-sm">
                        <p class="text-xs uppercase tracking-[0.24em] text-white/60">Étape {{ $index + 1 }}</p>
    ...
    <section class="mt-12">
        <div class="section-card px-6 py-10 sm:px-10">
            <div class="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                <div>
                    <p class="eyebrow">Besoin d'un premier échange ?</p>
                    <h2 class="section-title mt-3">Nous répondons volontiers à vos questions</h2>
                    <p class="subtle-text mt-4 max-w-2xl">
                        Tempérament, compatibilité avec votre foyer, disponibilités et modalités :
                        nous préférons un contact clair dès le début.
                    </p>
                </div>
