...
@section('meta_description', 'Contactez la chatterie pour parler d\'adoption, de disponibilités, du caractère des Abyssins et de la préparation du foyer.')
...
@section('content')
        ...
        <div class="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
                ...
                <p class="body-copy mt-6 max-w-2xl">
                    Nous privilégions un premier échange simple pour comprendre votre foyer, vos habitudes
                    et le type de compagnon que vous recherchez. Vous pouvez nous écrire via WhatsApp,
                    par téléphone ou par e-mail selon ce qui vous convient le mieux.
                </p>
                @if ($ownerName !== '')
    ...
    <section class="mt-12 grid gap-6 lg:grid-cols-[1fr_1fr]">
        <article class="section-card p-8">
            ...
            <h2 class="section-title mt-4">Les informations utiles à préparer</h2>
            <div class="mt-6 grid gap-4">
                <div class="detail-pill">
                    <p class="text-base font-semibold text-amber-950">Votre mode de vie et le temps de présence au foyer.</p>
                </div>
                <div class="detail-pill">
                    <p class="text-base font-semibold text-amber-950">La composition du foyer : enfants, autres animaux, rythme quotidien.</p>
                </div>
                <div class="detail-pill">
                    <p class="text-base font-semibold text-amber-950">Vos attentes : âge, sexe, disponibilité immédiate ou future.</p>
                </div>
            </div>
        </article>
